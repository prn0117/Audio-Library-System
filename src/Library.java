...
public class Library {
    ...
    private Playable aPlayable = new Song("dummyName", "dummy Song"); // in case setPlayable is not called

    public void setPlayable(Playable pPlayable){
        aPlayable = pPlayable;
    }
